...
const gameScreenshots = [
  { src: "/image-2.png", alt: "Game screenshot 1" },
  { src: "/image-4.png", alt: "Game screenshot 2" },
  { src: "/image-3.png", alt: "Game screenshot 3" },
  { src: "/image-7.png", alt: "Game screenshot 4" },
  { src: "/image-6.png", alt: "Game screenshot 5" },
  { src: "/image-5.png", alt: "Game screenshot 6" },
];
      ...
      <div className="relative w-full max-w-[1920px]">
        ...
        <section className="relative z-10 mt-[200px] md:mt-[300px] lg:mt-[400px] px-4 md:px-8 lg:px-[155px]">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            >
              <div className="relative w-[27.21px] h-[25.51px]">
                <div className="absolute w-3 h-2.5 top-0.5 left-0 bg-[url(/group-32.png)] bg-[100%_100%]" />
                <div className="absolute w-3.5 h-3 top-0 left-3.5 bg-[url(/group-33.png)] bg-[100%_100%]" />
                <div className="absolute w-3.5 h-3 top-3.5 left-3.5 bg-[url(/group-34.png)] bg-[100%_100%]" />
                <div className="absolute w-3 h-2.5 top-3.5 left-0 bg-[url(/group-35.png)] bg-[100%_100%]" />
              </div>
              Download
            </Button>
          </div>
          ...
          <img
            className="absolute w-[400px] md:w-[600px] lg:w-[689px] h-auto top-[200px] md:top-[300px] lg:top-[3822px] right-0 opacity-80 filter drop-shadow-2xl"
            alt="Spaceship element"
            src="/4872049f-137c-4e1d-8d6d-6c95a5ea7022--1--2.png"
          />
        </section>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              >
                <div className="w-[18px] h-[17px] relative">
                  <div className="absolute w-2 h-[7px] top-px left-0 bg-[url(/group-43.png)] bg-[100%_100%]" />
                  <div className="absolute w-[9px] h-2 top-0 left-[9px] bg-[url(/group-44.png)] bg-[100%_100%]" />
                  <div className="absolute w-[9px] h-2 top-[9px] left-[9px] bg-[url(/group-45.png)] bg-[100%_100%]" />
                  <div className="absolute w-2 h-[7px] top-[9px] left-0 bg-[url(/group-46.png)] bg-[100%_100%]" />
                </div>
                Download
              </Button>
            </div>
